...
<body>
            ...
            {{-- <div class="page-content"> --}}
                        ...
                        <div class="col-sm-12">
                            <div class="page-title-box">
                                <div class="float-right">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="javascript:void(0);">far car wash</a></li>
                            ...
                            <div class="card card-content">
                                <div class="card-body row justify-content-center">
                                    <div class="col-5 align-self-center">
                                        ...
                                        <p class="mb-2 text-muted font-13 text-nowrap">Pengunjung</p>
                                        <span class="badge badge-soft-success mt-1 shadow-none"><i class="mdi mdi-menu-up font-16"></i>20.15%</span>
                                    </div>
                                    <div class="col-7 align-self-center"><span class="peity-line" data-width="100%" data-peity='{ "fill": ["#b5f1e0"],"stroke": ["#0acf97"]}' data-height="80">1,2,3,4,3,6,3,5,3,3,4,2</span></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-xl-3">
                            <div class="card card-content">
                                <div class="card-body row justify-content-center">
                                    <div class="col-5 align-self-center">
                                        ...
                                        <p class="mb-2 text-muted font-13 text-nowrap">Orderan Masuk</p>
                                        <span class="badge badge-soft-danger mt-1 shadow-none"><i class="mdi mdi-menu-down font-16"></i>7.15%</span>
                                    </div>
                                    <div class="col-7 align-self-center text-right"><span class="peity-line" data-width="100%" data-peity='{ "fill": ["#d6d8f5"],"stroke": ["#777edd"]}' data-height="80">0,3,6,3,4,2,6,1,8,4,4,2</span></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-xl-3">
                            <div class="card card-content">
                                <div class="card-body row justify-content-center">
                                    <div class="col-5 align-self-center">
                                        ...
                                        <p class="mb-2 text-muted font-13 text-nowrap">Orderan Selesai</p>
                                        <span class="badge badge-soft-danger mt-1 shadow-none"><i class="mdi mdi-menu-down font-16"></i>6.05%</span>
                                    </div>
                                    <div class="col-7 align-self-center"><span class="peity-line" data-width="100%" data-peity='{ "fill": ["#fdebb5"],"stroke": ["#f9bc0b"]}' data-height="80">2,4,7,3,5,3,6,3,4,3,2,1,2</span></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-xl-3">
                            <div class="card card-content">
                                <div class="card-body row justify-content-center">
                                    <div class="col-5 align-self-center">
                                        ...
                                        <p class="mb-2 text-muted font-13 text-nowrap">Total Orderan</p>
                                        <span class="badge badge-soft-success mt-1 shadow-none"><i class="mdi mdi-menu-up font-16"></i>8.97%</span>
                                    </div>
                                    <div class="col-7 align-self-center"><span class="peity-bar" data-peity='{ "fill": ["#ffd1e1", "#ffd1e1"]}' data-width="100%" data-height="80">5,6,2,8,9,4,7,10,11,12,10,4,7,10</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-9 col-xl-9 border-right">
                                            <div class="card shadow-none mb-0">
                                                <div class="card-body"><div id="morris-line-chart" class="morris-chart overview-chart"></div></div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card mb-0 overview shadow-none">
                                                <div class="card-body border-bottom">
                                                    <div class="">
                                                        <div class="row align-items-center">
                                                            <div class="col-4">
                                                                <div class="overview-content"><i class="mdi mdi-share-variant text-success"></i></div>
                                                            </div>
                                                ...
                                                <div class="card-body border-bottom">
                                                    <div class="">
                                                        <div class="row align-items-center">
                                                            <div class="col-4">
                                                                <div class="overview-content"><i class="mdi mdi-gesture-double-tap text-purple"></i></div>
                                                            </div>
                                                            <div class="col-8 text-right">
                                                ...
                                                <div class="card-body border-bottom">
                                                    <div class="">
                                                        <div class="row align-items-center">
                                                            <div class="col-4">
                                                                <div class="overview-content"><i class="mdi mdi-earth text-warning"></i></div>
                                                            </div>
                                                            <div class="col-8 text-right">
                                                ...
                                                <div class="card-body">
                                                    <div class="">
                                                        <div class="row align-items-center">
                                                            <div class="col-4">
                                                                <div class="overview-content"><i class="mdi mdi-access-point text-pink"></i></div>
                                                            </div>
                                                            <div class="col-8 text-right">
                                                            ...
                                                            <div class="col-12">
                                                                <div class="progress mt-4" style="height: 6px;">
                                                                    <div
                                                                        class="progress-bar progress-animated bg-pink"
                                                                        role="progressbar"
                        ...
                        <div class="col-md-12 col-lg-6 col-xl-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-lg-8"><div id="world-map-markers" class="dashboard-map"></div></div>
                                        <div class="col-md-12 col-lg-4 align-self-center">
                                            <p class="text-muted font-13 mb-1"><i class="mdi mdi-checkbox-blank-circle mr-2 text-success"></i>India <span class="float-right">35%</span></p>
                                            ...
                                            <p class="text-muted font-13 mb-1"><i class="mdi mdi-checkbox-blank-circle mr-2 text-success"></i>USA <span class="float-right">58%</span></p>
                                            <div class="progress mb-4" style="height: 3px;">
                                            ...
                                            <p class="text-muted font-13 mb-1"><i class="mdi mdi-checkbox-blank-circle mr-2 text-danger"></i>Russia <span class="float-right">85%</span></p>
                                            <div class="progress mb-4" style="height: 3px;">
                                            ...
                                            <p class="text-muted font-13 mb-1"><i class="mdi mdi-checkbox-blank-circle mr-2 text-success"></i>Australia <span class="float-right">71%</span></p>
                            ...
                            <div class="card bg-primary text-white income">
                                <div class="card-body">
                                    ...
                                    <div class="">
                                        ...
                                        <span class="float-right">Last Month : $6500.50</span> <a href="#" class="text-white my-4">Read More<i class="mdi mdi-arrow-right ml-2"></i></a>
                                        <div class="mt-4"><span class="peity-bar" data-peity='{ "fill": ["#9dcee8", "#9dcee8"]}' data-width="100%" data-height="162">1,2,3,4,3,6,3,5,3,8,4,2,6,3,5,3,8,4,2,5,2,3,4,3,6</span></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                {{-- <footer class="footer text-center text-sm-left">
                    &copy; 2018 Amezia <span class="text-muted d-none d-sm-inline-block float-right">Crafted with <i class="mdi mdi-heart text-danger"></i> by Themesbrand</span>
                </footer>
            </div> --}}
            <!-- end page content -->
</body>

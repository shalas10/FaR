...
<body class="template-page-about-style-2">
                    ...
                    <nav>   
                        ...
                        <div class="template-component-menu-default">
                            <ul class="sf-menu">
                                ...
                                <li>
                                    <a href="/tentang" class="template-state-selected">Tentang</a>
                                </li>
                                <li>
            ...
            <div class="template-header-bottom">
                ...
                <div class="template-main">
                    <div class="template-header-bottom-page-title">
                        <h1>Tentang FaR Car Wash</h1>
                    </div>

                    <div class="template-header-bottom-page-breadcrumb">
                        <a href="index.html">Home</a><span class="template-icon-meta-arrow-right-12"></span><a href="#">Tentang</a>
                    </div>
                </div>
